  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Community Platform: Ignite your interests through blogs, documentation, videos, streams, and more. Connect, discuss, and build relationships, all in one place."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Community Platform: Ignite your interests through blogs, documentation, videos, streams, and more. Connect, discuss, and build relationships, all in one place.`}
            </Text>
            <Box
